...
describe('Minter', () => {
    ...
    beforeEach(async () => {
        ...
        minter = await Minter.deploy(bundleToken.address, await dev.getAddress(), BLOCK_REWARDS, 0);
    ...
    context('when use pool', async () => {
        ...
        it('should work', async () => {
            ...
            expect(await bundleToken.balanceOf(await dev.getAddress())).to.be.bignumber.eq(
            ...
            expect(await bundleToken.balanceOf(await bob.getAddress())).to.be.bignumber.eq(
                ethers.utils.parseEther('7500')
            );
            expect(await bundleToken.balanceOf(await dev.getAddress())).to.be.bignumber.eq(
            ...
            expect(await bundleToken.lockOf(await dev.getAddress())).to.be.bignumber.eq(
            ...
            expect(await bundleToken.lockOf(await alice.getAddress())).to.be.bignumber.eq(
            ...
            expect(await bundleToken.lockOf(await bob.getAddress())).to.be.bignumber.eq(
            ...
            expect(await bundleToken.canUnlockAmount(await alice.getAddress())).to.be.bignumber.eq(
                ethers.utils.parseEther('180000')
            );
            expect(await bundleToken.canUnlockAmount(await bob.getAddress())).to.be.bignumber.eq(
                ethers.utils.parseEther('45000')
            );
            expect(await bundleToken.canUnlockAmount(await dev.getAddress())).to.be.bignumber.eq(
                ethers.utils.parseEther('22500')
            );
